interface StadtplanTagNachtTextProps {
  stylesDesc?: string;
}
const StadtplanTagNachtText = ({
  stylesDesc = " (Tag | Nacht)",
}: StadtplanTagNachtTextProps) => {
  return (
    <li>
      ...
      Prozess aktualisierte Zusammenführung des Straßennetzes der OpenStreetMap
      mit amtlichen Geobasisdaten des Landes NRW aus den Fachverfahren ALKIS
...
export default StadtplanTagNachtText;
